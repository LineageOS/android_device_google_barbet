...
VENDOR_SKIP_FILES_REDBULL=(
    ...
    "bin/hw/android.hardware.usb@1.2-service.barbet"
    ...
    "etc/init/android.hardware.usb@1.2-service.barbet.rc"
    ...
    "etc/vintf/manifest/android.hardware.usb@1.2-service.barbet.xml"
